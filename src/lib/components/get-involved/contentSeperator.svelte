...
>
	<h3 class="text-center font-bold text-5xl z-20 text-white">
		Alone we do <span class="text-[#FFBA41]">little.</span><br />
		Together we achieve <span class="text-[#0155BD]">more.</span>
	</h3>
</div>
	...
	<div class="lg:w-1/2 md:px-24 px-3 py-10">
		<div class="px-6 border-l-4 border-[#FFBA41]">
			<div class="mb-10">
				...
				<div class="text-sm">
					Partner with us to make a real impact.
				</div>
			</div>

			<div class="grid grid-cols-2 font-semibold">
				<div class="flex gap-5 items-center">
					<div class="w-4 h-4 flex gap-[1px]">
						<NextIcon /><NextIcon />
					</div>
					<div class="text-sm">Join Our Team</div>
				</div>
