	...
	let members = [
		{
			...
			feedback:
				'It was we really have good co workers and culture and being very active and can learn lot from this internship',
			image: 'src/lib/assets/get-involved/tripti.png'
		},
		{
			name: 'Shreya',
			role: 'Content & Research',
			feedback:
				'Open and supportive environment where ideas are valued, feedback is encouraged and growth is prioritised.',
			image: 'src/lib/assets/get-involved/shreya.png'
		},
		{
			...
			feedback:
				'It was we really have good co workers and culture and being very active and can learn lot from this internship',
			image: 'src/lib/assets/get-involved/aditya.png'
		},
		{
			name: 'Rohan Sharma',
...
<div
	...
	style="background-image: url('src/lib/assets/get-involved/community.png');"
>
	<!-- Carousel Content -->
	<div class="w-full max-w-4xl mx-auto relative">
		<h2
			class="md:text-center text-left text-2xl md:text-3xl font-extrabold text-[#0D2460] mb-10 ml-3"
		>
			...
			<div class="flex overflow-hidden w-full">
				{#each members as member, index (index)}
					{#if index >= currentIndex && index < currentIndex + (isWideScreen ? 3 : 1)}
						<div
							class="w-full sm:w-1/3 md:h-[26rem] h-[12rem] px-2 flex-shrink-0 transition-transform duration-500 ease-in-out transform translate-x-[${index -
								currentIndex}00%]"
						>
							<div
								class="bg-white p-4 md:p-0 rounded-xl shadow-lg flex flex-col items-center h-full"
							>
								<div class="flex flex-row md:flex-col gap-3">
									...
									<img
										src="src/lib/assets/get-involved/quote.png"
										alt="quote"
...
<style>
	/* Custom styles for buttons and carousel */
	button {
		width: 40px;
		height: 40px;
	}
