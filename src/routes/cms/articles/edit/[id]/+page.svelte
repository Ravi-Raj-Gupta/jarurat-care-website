	...
	<div class="content">
		...
		<div class="page">
			<div class="header">
				...
				<p>Update your draft article or make changes before submitting for peer review.</p>
			</div>
					...
					<!-- REGULAR ARTICLE FORM -->
						<div class="form-section">
							...
							<div class="input-group">
								...
								<input type="text" id="title" name="title" value={article?.title || ''} required placeholder="Enter a catchy title..." />
							</div>
							<div class="input-grid">
								<div class="input-group">
									<label for="author_name_credentials">Author Name & Credentials</label>
									<input type="text" id="author_name_credentials" name="author_name_credentials" placeholder="e.g., Dr. Jane Doe, MD, Ph.D." value={article?.author_name_credentials || profile?.full_name || ''} />
								</div>
								<div class="input-group">
									<label for="category">Category</label>
									<select id="category" name="category" value={article?.category || 'General Health'}>
							...
							<div class="input-grid">
								<div class="input-group">
									...
									<input type="text" id="tags" name="tags" value={article?.tags || ''} placeholder="e.g., wellness, diet, heart" />
								</div>
								<div class="input-group">
									<label for="cover_image_url">Cover Image URL</label>
									<input type="url" id="cover_image_url" name="cover_image_url" value={article?.cover_image_url || ''} placeholder="https://..." />
								</div>
							</div>
							<div class="input-group">
								<label for="abstract">Executive Summary / Abstract</label>
								<textarea id="abstract" name="abstract" rows="3" placeholder="Brief overview of the article...">{article?.abstract || ''}</textarea>
							</div>
						</div>
						...
						<div class="form-section">
							...
							<div class="input-group">
								...
								<textarea id="explanation" name="explanation" rows="6" placeholder="The core content...">{article?.explanation || ''}</textarea>
							</div>
							<div class="input-group">
