...
<svelte:head>
	<title>Edit Research Paper | Doctor Dashboard</title>
</svelte:head>
	...
	<div class="content">
		...
		<div class="page">
			<div class="header">
				...
				<p>
					Update your draft or make changes before submitting for peer review.
				</p>
			</div>
				...
				>
						...
						<div class="input-group">
							...
							<input
								type="text"
								id="title"
								name="title" value={research?.title || ''}
								required
						...
						<div class="input-grid">
							<div class="input-group">
								...
								<input
									...
									name="authors_and_affiliations" value={research?.authors_and_affiliations || ''}
							...
							<div class="input-group">
								...
								<input
									...
									name="corresponding_author_details" value={research?.corresponding_author_details || ''}
						...
						<div class="input-grid">
							<div class="input-group">
								...
								<input
									type="text"
									id="keywords"
									name="keywords" value={research?.keywords || ''}
							...
							<div class="input-group">
								...
								<input
									type="url"
									id="featured_image"
									name="featured_image" value={research?.featured_image || ''}
									placeholder="https://..."
								/>
							</div>
						</div>
					...
					<div class="form-section">
						...
						<div class="input-group">
							...
							<textarea
								...
								name="introduction"
								rows="5"
							>{research?.introduction || ''}</textarea>
						</div>
						...
						<div class="input-group">
							...
							<textarea
								...
								rows="4"
							>{research?.literature_review || ''}</textarea>
						</div>
					...
					<div class="form-section">
						...
						<div class="input-grid">
							<div class="input-group">
								...
								<textarea
									...
									rows="3"
								>{research?.ethics_statement || ''}</textarea>
							</div>
						...
						<div class="input-grid">
							<div class="input-group">
								...
								<textarea
									...
									rows="2"
								>{research?.conflict_of_interest || ''}</textarea>
							</div>
							...
							<div class="input-group">
								...
								<textarea
									...
									rows="2"
								>{research?.author_contributions || ''}</textarea>
							</div>
						</div>
						...
						<div class="input-grid">
							<div class="input-group">
								...
								<textarea
									...
									rows="2"
								>{research?.data_availability || ''}</textarea>
							</div>
							...
							<div class="input-group">
								...
								<textarea
									...
									rows="2"
								>{research?.acknowledgements || ''}</textarea>
							</div>
						</div>
						...
						<div class="input-group">
							...
							<textarea
								...
								rows="4"
							>{research?.references_text || ''}</textarea>
						</div>
